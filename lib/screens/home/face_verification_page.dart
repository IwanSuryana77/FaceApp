...
class _FaceVerificationPageState extends State<FaceVerificationPage> {
  ...
  // Drag Offset (biarkan, jika tidak ingin geser tinggal hapus variabel ini)
  double _cardOffset = 0.0;
  double _initialDrag = 0.0;
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        const EdgeInsets.only(left: 22.0, bottom: 4),
                    child: Text(
                  ...
                  Padding(
                    padding: const EdgeInsets.only(
                        left: 22, right: 22, bottom: 4, top: 2),
                    child: Container(
              ...
              Expanded(
                child: Stack(
                  children: [
                    ...
                    // Card bawah: COLLAPSIBLE dengan tombol
                    Positioned(
                      left: 0,
                      right: 0,
                      bottom: _cardOffset,
                      child: GestureDetector(
                        onVerticalDragStart: (details) {
                          _initialDrag = details.globalPosition.dy - _cardOffset;
                        },
                        onVerticalDragUpdate: (details) {
                          double newOffset =
                              details.globalPosition.dy - _initialDrag;
                          double maxOffset = 0;
                          double minOffset = -180;
                          setState(() {
                            _cardOffset = newOffset.clamp(minOffset, maxOffset);
                          });
                        },
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              AnimatedCrossFade(
                                firstChild: _AbsensiInfo(
                                  userName: userName,
                                  userEmail: userEmail,
                                  absenLokasiString: _absenLokasiString,
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                  onPressed: (_loading || _userLoading)
                                      ? null
                                      : () => _detectAndVerify(context),
                                  style: ElevatedButton.styleFrom(
                                    backgroundColor: primaryPurple,
                                    foregroundColor: Colors.white,
...
class _AbsensiInfo extends StatelessWidget {
  final String? userName;
  final String? userEmail;
  final String? absenLokasiString;
  final String? alamatLengkap;
  final VoidCallback getLiveLocation;

  const _AbsensiInfo({
    Key? key,
    this.userName,
    this.userEmail,
    this.absenLokasiString,
    this.alamatLengkap,
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              else if (absenLokasiString != null)
                Text(
                  "Koordinat: $absenLokasiString",
                  style: const TextStyle(
                    color: Colors.black54,
                    fontSize: 11,
                  ),
...
//=== Dashed Corner ONLY Overlay Box ===
class _DashedCornerRectOverlay extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Center(
      child: CustomPaint(
        size: const Size(260, 320),
        painter: _DashedCornerRectPainter(),
      ),
    );
  }
}

class _DashedCornerRectPainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    ...
    const cornerLen = 34.0; // Length of each corner
